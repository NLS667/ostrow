...
mix.autoload({
    ...
    .sass('resources/assets/sass/plugins/Bootstrap/bootstrap.css', 'public/css/bootstrap.css')
    .styles([
    ...
    .scripts([
        ...
        'resources/assets/js/plugins/moment-with-locales.min.js',
        'resources/assets/js/plugins/moment-timezone.js',
