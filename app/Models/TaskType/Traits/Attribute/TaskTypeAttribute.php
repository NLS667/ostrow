...
namespace App\Models\TaskType\Traits\Attribute;
...
trait TaskTypeAttribute
{
    ...
    {
        if (access()->allow('edit-tasktype')) {
            return '<a class="'.$class.'" data-toggle="tooltip" data-placement="top" title="Edytuj" href="'.route('admin.taskType.edit', $this).'">
    ...
    {
        if (access()->allow('delete-tasktype')) {
            $name = ($class == '' || $class == 'dropdown-item') ? 'Usuń' : '';

            return '<a class="'.$class.'" data-toggle="tooltip" data-placement="top" title="Usuń" href="'.route('admin.taskType.destroy', $this).'"
            data-method="delete"
