...
namespace App\Models\Device\Traits\Attribute;
...
trait DeviceAttribute
{
    ...
    public function getEditButtonAttribute($class)
    {
        if (access()->allow('edit-model')) {
            return '<a class="'.$class.'" data-toggle="tooltip" data-placement="top" title="Edytuj" href="'.route('admin.device.edit', $this).'">
