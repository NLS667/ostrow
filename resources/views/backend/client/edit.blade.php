              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-sm-6 form-group bmd-form-group {{ $errors->has('comm_adr_region') ? ' has-danger' : '' }} {{ $client->comm_adr_region ? ' is-filled' : '' }}">
