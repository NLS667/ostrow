@extends ('backend.layouts.app', ['activePage' => 'role-management', 'titlePage' => 'Zarządzanie Usługami'])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                {{ Form::open(['route' => 'admin.service.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-service']) }}
                ...
                <div class="card">
                    <div class="card-header card-header-primary d-flex justify-content-between align-items-center">
                        ...
                        <ul class="nav nav-tabs">
                          <li class="nav-item">
                            <a href="{{ route('admin.service.index') }}" class="nav-link btn btn-sm btn-default">Powrót do listy</a>
                          </li>
                        </ul>
                    </div><!-- /.card-header -->
