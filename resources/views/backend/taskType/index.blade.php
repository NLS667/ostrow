@extends('backend.layouts.app', ['activePage' => 'task-management', 'titlePage' => 'Zarządzanie Rodzajami Zadań'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive data-table-wrapper">
                            <table id="task-type-table" class="table dataTable table-striped table-hover table-no-bordered dtr-inline" cellspacing="0" width="100%" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        <th>Nazwa</th>
                                        <th>Opis</th>
...
@section('after-scripts')
    ...
    <script>
        $(function() {
            ...
            var dataTable = $('#task-type-table').DataTable({
                columnDefs: [
                ...
                ajax: {
                    url: '{{ route("admin.taskType.get") }}',
                    type: 'post',
                    data: {status: 1, trashed: false}
                },
                columns: [
                    {data: 'name', name: 'task_types.name'},
                    {data: 'description', name: 'task_types.description'},
                    {data: 'tasks', name: 'tasks'},
                    {data: 'created_at', name: 'task_types.created_at'},
                    {data: 'updated_at', name: 'task_types.updated_at'},
