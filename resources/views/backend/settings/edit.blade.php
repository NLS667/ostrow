@extends('backend.layouts.app', ['activePage' => 'edit-settings', 'titlePage' => trans('labels.backend.settings.management') . ' | ' . trans('labels.backend.settings.edit')])

@section('page-header')
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{ trans('labels.backend.settings.management') }}</h1><small>{{ trans('labels.backend.settings.edit') }}</small>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="box box-info">
	...
	<div class="box-body setting-block">
		...
		<ul id="myTab" class="nav nav-tabs setting-tab-list" role="tablist">
			<li role="tab" class="nav-link active">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						...
						<div class="img-remove-favicon">
							...
							<i id="remove-favicon-img" class="fas fa-times remove-logo" data-id="favicon" aria-hidden="true"></i>
							@endif
						</div>
					</div>
					<!--col-lg-10-->
