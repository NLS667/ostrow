                            ...
                            <table id="tasks-table" class="table dataTable table-striped table-hover table-no-bordered dtr-inline" cellspacing="0" width="100%" style="width: 100%;">
                                ...
                                <thead class="transparent-bg">
                                    <tr>
                                        ...
                                        <th>
                                            <div class="input-group position-relative">
                                                {!! Form::select('status', [ 'Nowe' => 'Nowe', 'Oczekujące' => 'Oczekujące', 'Nadchodzące' => 'Nadchodzące', 'Po terminie' => 'Po terminie'], null, ["class" => "search-input-select form-control", "data-column" => 3, "placeholder" => 'Status']) !!}
                                            </div>
                                        </th>
                                        <th></th>
                                        <th></th>
